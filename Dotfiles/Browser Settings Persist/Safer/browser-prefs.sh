...
echo '#!/bin/bash 
echo "user_pref(\"extensions.torbutton.security_slider\", 2);
...
user_pref(\"media.navigator.enabled\", false);" >> /home/amnesia/.tor-browser/profile.default/user.js' | tee -a Persistent/scripts/browser-preferences.sh
